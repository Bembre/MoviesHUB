...
<body>
    ...
    <div class="home__carousel owl-carousel" id="MoviesHub-hero">
        <?php $sql="SELECT * FROM movies";
$all = $conn->query($sql);
 while($row = mysqli_fetch_assoc($all)) { ?>

 
            <div class="home__card info" data-id='<?php echo $row['title']?>' style="max-height: 70vh;">
		...
		<button class="home__nav home__nav--prev" data-nav="#MoviesHub-hero" type="button"></button>
		<button class="home__nav home__nav--next" data-nav="#MoviesHub-hero" type="button"></button>
	</div>
	<!-- end home -->
...
$all = $conn->query($sql);
 while($row = mysqli_fetch_assoc($all)) { ?>
                <div class="card info " data-id='<?php echo $row['title']?>'>
	...
	<section class="section section--pb0">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="section__title"><a href="category.html">South Movies</a></h2>
				</div>

				<div class="col-12">
					<div class="section__carousel-wrap">
						<div class="section__carousel owl-carousel" id="classic">
						<?php $sql="SELECT * FROM movies where t1='south' or t2='south' or t3='south' or t4='south'";
...
<script>
    $(document).ready(function(){
        $('.info').click(function(){
            var title = $(this).data('id'); // Use 'id' instead of 'adhar'
