						...
						<ul class="header__nav">
							...
							<li class="header__nav-item">
								...
								<ul class="dropdown-menu header__nav-menu header__nav-menu--scroll" aria-labelledby="dropdownMenu3">
									<li><a href="https://MoviesHub.volkovdesign.com/admin/index.html" target="_blank">Admin Login</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<?php $sql="SELECT * FROM movies where t1='hollywood' or t2='hollywood' or t3='hollywood' or t4='hollywood'";
$all = $conn->query($sql);
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">© MoviesHub Created by <strong>Prathamesh Bembre</strong></small>
					</div>
				</div>
			</div>
		</div>
...
<!-- Mirrored from MoviesHub.volkovdesign.com/main/category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 07:05:30 GMT -->
</html>