$(document).ready(function () {
	...
	Upload gallery
	==============================*/
	$('.form__gallery-upload1').on('change', function() {
	...
	$('.form__gallery-upload2').on('change', function() {
		var length = $(this).get(0).files.length;
		var galleryLabel  = $(this).attr('data-name');
	...
	$('.form__gallery-upload3').on('change', function() {
		var length = $(this).get(0).files.length;
		var galleryLabel  = $(this).attr('data-name');
	...
	$('.form__gallery-upload4').on('change', function() {
		var length = $(this).get(0).files.length;
		var galleryLabel  = $(this).attr('data-name');
