...
<body>
    <section class="nav_bar">
        <div class="logo">
            <a href="dashboard.php" class="title_div">
        ...
        <div class="menu">
            ...
            <li class="search">
                <a href="add.php"><i class="bi bi-plus-circle"></i> <span>Add a Movie</span></a>
            </li>
            <li class="movies">
        ...
        <div class="profile">
                <a href="/movies/logout.php"><i class="bi bi-box-arrow-right"></i> <span>Logout</span></a>
