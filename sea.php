...
// Bind the parameter and add wildcard '%' to allow partial matches
$searchTerm = '%' . $search . '%';
...
<!-- Mirrored from MoviesHub.volkovdesign.com/main/details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 07:05:30 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
					...
					<div class="header__content">
						...
						<ul class="header__nav">
							<li class="header__nav-item">
								<a class="header__nav-link" href="index.php" role="button">Home</a>
							</li>
							<li class="header__nav-item">
								<a class="header__nav-link" href="category.php" role="button">Category</a>
							</li>
							<li class="header__nav-item">
								<a class="header__nav-link" href="about.html">About us</a>
							</li>
							<li class="header__nav-item">
								<a class="header__nav-link header__nav-link--live" href="contacts.html">Contacts</a>
							</li>
							<li class="header__nav-item">
								...
								<ul class="dropdown-menu header__nav-menu header__nav-menu--scroll" aria-labelledby="dropdownMenu3">
									<li><a href="signin.html" target="_blank">Admin Login</a></li>
						...
						<form action="sea.php" method="post" class="header__form">
								<input class="header__form-input" type="text" name="search" placeholder="I'm looking for...">
								<input type="submit" style="background:none; color:#fff;border:none;margin-left:-80px; " value="Search">
	...
	<?php 
		...
		<div class="section__bg" style="background-image: url('media/<?php echo $row['s1']; ?>'); background-position: center; background-size: cover;"></div>
		<div class="container">
			<!-- article -->
			<div class="article">
				<div class="row">
					<div class="col-12 col-xl-8">
						<!-- trailer -->
						<a href="<?php echo $row['link'] ?>" class="article__trailer open-video">
    ...
    <!-- Video files -->
    <source src="media/<?php echo $row['movie']; ?>" type="video/mp4">
    
    <!-- Fallback for browsers that don't support the <video> element -->
    <a href="<?php echo $row['movie']; ?>" download>Download</a>
</video>
						...
						<div class="article__actions article__actions--details">
							<div class="article__download">
								Download&nbsp;
								<a href="media/<?php echo $row['movie']?>" download="<?php echo $row['title']?>">
    ...
    <div class="series-wrap">
        ...
        <div class="section__carousel-wrap">
            <div class="row">
                <div class="col-md-6">
                    <div class="series">
                        <a href="details.php" class="series__cover">
                            <img src="media/<?php echo $row['s1'] ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="series">
                        <a href="details.html" class="series__cover">
                            <img src="media/<?php echo $row['s2'] ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="series">
                        <a href="details.html" class="series__cover">
                            <img src="media/<?php echo $row['s3'] ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="series">
                        <a href="details.html" class="series__cover">
                            <img src="media/<?php echo $row['s4'] ?>" alt="">
                        </a>
                    </div>
                </div>
            </div>
					...
					<div class="col-12 col-xl-8">
						...
						<div class="categories">
							...
							<a href="category.html" class="categories__item"><?php echo $row['t1']; ?></a>
							<a href="category.html" class="categories__item"><?php echo $row['t2']; ?></a>
							<a href="category.html" class="categories__item"><?php echo $row['t3']; ?></a>
							<a href="category.html" class="categories__item"><?php echo $row['t4']; ?></a>
						</div>
						<!-- end categories -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0 offset-xl-1">
					<h6 class="footer__title">MoviesHub</h6>
