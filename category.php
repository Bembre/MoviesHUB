...
<!-- Mirrored from flixtv.volkovdesign.com/main/category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 07:05:29 GMT -->
<head>
	<meta charset="utf-8">
				...
				<div class="col-12">
					<div class="catalog__nav">
						<div class="catalog__select-wrap">
							<select class="catalog__select" name="genres"  onchange="location = this.value;">
								<option value="All genres">All genres</option>
								<option value="c1.php">Action</option>
								<option value="c2.php">Drama</option>
								<option value="c3.php">Horror</option>
								<option value="c4.php">BollyWood</option>
								<option value="c5.php">Crime</option>
								<option value="c6.php">English Movies</option>
								<option value="c7.php">Hindi Dubbed</option>
								<option value="c8.php">HollyWood</option>
								<option value="c9.php">Marathi</option>
								<option value="c10.php">South Hindi Movies</option>
								<option value="c11.php">Thriller</option>
							</select>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							...
							<div class="card">
								<a href="details.html" class="card__cover">
									<img src="media/<?php echo $row['img']?>" alt="">
								...
								<h3 class="card__title"><a href="details.html"><?php echo $row['title']?></a></h3>
								<ul class="card__list">
									<li><?php echo $row['t1']?></li>
									<li><?php echo $row['t2']?></li>
									<li><?php echo $row['t3']?></li>
								</ul>
							</div>
...
<!-- Mirrored from flixtv.volkovdesign.com/main/category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 07:05:30 GMT -->
</html>